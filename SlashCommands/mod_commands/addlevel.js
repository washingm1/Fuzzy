...
module.exports = {
    name: "addlevel",
    description: "Add levels to a specified user",
...
run: async (client, interaction, args, message) => {
 console.log(interaction)
    ...
    interaction.editReply({content: `Successfully added  ${amount}  level(s) to <@${target}>`})
    db.add(`guild_${guild.id}_level_${target}`, amount)
